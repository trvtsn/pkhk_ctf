use crate::server::{db::structs::DbUser, enums::ResultStatus, structs::ApiResult};
    ...
    view! {
        <div class="bg-yale-blue-50 hover:bg-yale-blue-100 rounded-lg p-4 content-center">
            ...
            <Show when=move || editing_password.get()>
                ...
                <input class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" type="password" name="new_password" bind:value=new_password_signal/>
                
                <label class="block text-sm font-medium text-gray-700 mb-1">"Confirm New Password"</label>
                <input class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" type="password" name="confirm_new_password" bind:value=confirm_new_password_signal/>
                {confirm_password_ui}
            </Show>
