...
pub enum ToastMessageType {
    ...
    NoChangesMade,
    ProxmoxPoolCreated,
    ProxmoxPoolCreateFail,
    ProxmoxPoolDeleted,
    ProxmoxPoolDeleteFail,
    ProxmoxUserCreated,
    ProxmoxUserCreateFail,
    ProxmoxUserDeleted,
    ProxmoxUserDeleteFail,
    UserCreated,
    UserCreateFail,
    UserDeleted,
    UserDeleteFail,
...
impl std::fmt::Display for ToastMessageType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ToastMessageType::ProxmoxPoolCreated => write!(f, "Successfully created Proxmox user pool"),
            ToastMessageType::ProxmoxPoolCreateFail => write!(f, "Failed to create Proxmox user pool"),
            ToastMessageType::ProxmoxPoolDeleted => write!(f, "Successfully deleted Proxmox user pool"),
            ToastMessageType::ProxmoxPoolDeleteFail => write!(f, "Failed to delete Proxmox user pool"),
            ToastMessageType::ProxmoxUserCreated => write!(f, "Successfully created Proxmox user"),
            ToastMessageType::ProxmoxUserCreateFail => write!(f, "Failed to create Proxmox user"),
            ToastMessageType::ProxmoxUserDeleted => write!(f, "Successfully deleted Proxmox user"),
            ToastMessageType::ProxmoxUserDeleteFail => write!(f, "Failed to delete Proxmox user"),
