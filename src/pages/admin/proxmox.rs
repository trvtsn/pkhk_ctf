use crate::server::{admin::{get_ldap, get_proxmox_conf, test_proxmox, update_proxmox}, db::{enums::ProxmoxAuthType, structs::ProxmoxArgs}, enums::ResultStatus, structs::ApiResult};
...
pub fn Proxmox() -> impl IntoView {
    ...
    let ldap_enabled = RwSignal::new(true);
    ...
    view! {
        <Suspense fallback=move || {
            ...
            {move || {
                ...
                ldap_enabled.set(ldap_args.enabled.0);
                ...
                if ldap_enabled.get() {
                    ...
                    view! {
                        <p>"Please setup or enable LDAP configuration first."</p>
                    }.into_any()
                }
            }}
        </Suspense>
