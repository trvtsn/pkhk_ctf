use crate::{components::utils::HidePasswordButton, server::{db::structs::LdapArgs, enums::ResultStatus, structs::ApiResult}};
...
pub fn Ldap() -> impl IntoView {
    ...
    view! {
        ...
        // }>
        //     {move || {
        //         let ldap_args = ldap_resource.get().unwrap_or_default();
        //         if ldap_args.is_some() {
        //             let ldap_args = ldap_args.unwrap_or_default();
        ...
        //                 if let Ok(ApiResult { result, .. }) = crate::server::admin::test_ldap(LdapArgs {
        //                         url,
        //                         bind_dn,
        //                         bind_pw,
        //                         base_dn
        ...
        //         } else {
        //             spawn_local(async move {
        //                 _ = crate::server::admin::insert_ldap(LdapArgs::default()).await;
        //             });
        //         }
                    ...
                    <div class=r#"flex gap-3 mt-2"#>
                        ...
                        <button
                            ...
                            on:click=move |_| {
                                ...
                                let base_dn = base_dn.get();
                                spawn_local(async move {
                                    if let Ok(ApiResult { result, .. }) = crate::server::admin::update_ldap(LdapArgs {
                                            url,
                                            bind_dn,
                                            bind_pw,
                                            base_dn
